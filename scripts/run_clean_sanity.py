...
def report_schema() -> dict[str, Any]:
    return {
        ...
        "final_active_DAG_count": None,
        "final_active_task_count": None,
        "task_lifecycle_counts": {},
        "service_phase_counts": {},
        "ready_task_count_mean": None,
        "ready_task_count_max": None,
        "skipped_ready_due_to_no_legal_candidate_count": None,
        "assignment_buffer_entry_count": None,
        "successfully_committed_assignment_count": None,
        "reward_completed_task_count": None,
        "completed_non_sink_task_count": None,
        "returning_sink_task_count": None,
        "completed_sink_task_count": None,
...
def _merge_eval_metrics(report: dict[str, Any], eval_summary: dict[str, Any]) -> None:
    ...
    for output_key, eval_key in [
        ...
        ("final_active_DAG_count", "final_active_DAG_count"),
        ("final_active_task_count", "final_active_task_count"),
        ("task_lifecycle_counts", "task_lifecycle_counts"),
        ("service_phase_counts", "service_phase_counts"),
        ("ready_task_count_mean", "ready_task_count_mean"),
        ("ready_task_count_max", "ready_task_count_max"),
        ("skipped_ready_due_to_no_legal_candidate_count", "skipped_ready_due_to_no_legal_candidate_count"),
        ("assignment_buffer_entry_count", "assignment_buffer_entry_count"),
        ("successfully_committed_assignment_count", "successfully_committed_assignment_count"),
        ("reward_completed_task_count", "reward_completed_task_count"),
        ("completed_non_sink_task_count", "completed_non_sink_task_count"),
        ("returning_sink_task_count", "returning_sink_task_count"),
        ("completed_sink_task_count", "completed_sink_task_count"),
        ("unfinished_DAG_progress_samples", "unfinished_DAG_progress_samples"),
        ("executor_queue_summary", "executor_queue_summary"),
