...
def _serialize_assignment_record(
    ...
    payload: dict[str, Any] = {
        ...
        "actor_selected_uav": record.actor_selected_uav,
        "executor_selected_uav": record.executor_selected_uav,
    ...
    if args.write_attribution:
        attribution_writer = _AttributionWriter(
            args.attribution_path,
            {
                ...
                "use_task_type_attribute_hyperedges": config.USE_TASK_TYPE_ATTRIBUTE_HYPEREDGES,44
        "strict_selective_hgnn_score": config.USE_STRICT_SELECTIVE_HGNN_SCORING,
        "pair_feature_mode": config.TASK_UAV_PAIR_FEATURE_MODE,
